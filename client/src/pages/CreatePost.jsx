...
export default function CreatePost() {
    ...
    return (
        <div className='p-3 max-w-7xl mx-auto min-h-screen'>
            <h1 className='text-center text-5xl my-7 font-bold'>Create a post</h1>
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                ...
                <ReactQuill theme='snow' placeholder='write something...' className='h-72 mb-12 text-black dark:text-white' required onChange={(value) => setFormData({ ...formData, content: value })} />
